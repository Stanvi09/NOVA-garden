...
export default function PlantProjectModal({ isOpen, onClose, onPlantComplete }: Props) {
  ...
  // Close on Escape, but never while a plant/import is actively submitting —
  // that would abandon an in-flight request with no way to know it happened.
  useEffect(() => {
    if (!isOpen) return;
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 20 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <h2 id="plant-modal-title" style={{ fontSize: 24, margin: 0, color: "var(--color-forest)" }}>Plant a New Project</h2>
            </div>
          ...
          <>
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: tab === "zip" ? "var(--color-surface)" : "transparent",
                  color: tab === "zip" ? "var(--color-forest)" : "var(--color-muted)",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: tab === "folder" ? "var(--color-surface)" : "transparent",
                  color: tab === "folder" ? "var(--color-forest)" : "var(--color-muted)",
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: 6,
                  border: "none",
                  background: tab === "url" ? "var(--color-surface)" : "transparent",
                  color: tab === "url" ? "var(--color-forest)" : "var(--color-muted)",
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ marginBottom: 16 }}>
                <label style={{ display: "block", fontSize: 13, color: "var(--color-muted-strong)", marginBottom: 6 }}>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: "8px 14px",
                      borderRadius: 8,
                      background: isCurrent ? "var(--color-ivory)" : isPassed ? "var(--color-teal-bg)" : "var(--color-surface-soft)",
                      border: isCurrent
