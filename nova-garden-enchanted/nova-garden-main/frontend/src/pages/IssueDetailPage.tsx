  ...
  return (
    ...
    >
      <div style={{ marginBottom: 16 }}>
        ...
        {subtitle && <p style={{ margin: "4px 0 0", fontSize: 13, color: "var(--color-muted)" }}>{subtitle}</p>}
      </div>
      {children}
    </section>
  );
...
export default function IssueDetailPage() {
  ...
  if (!issue) {
    return (
      <div style={{ padding: 40, background: "transparent", minHeight: "100vh" }}>
  ...
  return (
    <main style={{ maxWidth: 1100, margin: "auto", padding: "32px 24px", background: "transparent", minHeight: "100vh" }}>
      {/* Top Breadcrumb */}
      <div style={{ marginBottom: 16 }}>
        <Link
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
              ...
              <span
                style={{
                  ...
                  padding: "3px 8px",
                  borderRadius: 6,
                  background: issue.severity === "CRITICAL" ? "var(--color-blossom-bg)" : "var(--color-gold-bg)",
              ...
              <span
                style={{
                  ...
                  padding: "3px 8px",
                  borderRadius: 6,
                  background: isResolved ? "var(--color-teal-bg)" : "var(--color-ivory)",
            ...
            <p style={{ margin: 0, fontSize: 14, color: "var(--color-muted-strong)", lineHeight: 1.5 }}>{issue.description}</p>
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 20 }}>
        ...
        >
          {data.dna?.related?.length > 0 ? (
              ...
              {data.dna.related.map((rel: any) => (
                ...
                >
                  <div>
                    ...
                    <div style={{ display: "flex", gap: 8, marginTop: 4, fontSize: 12, color: "var(--color-muted)" }}>
            ...
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>No direct DNA relatives found in historical records.</p>
          )}
        </SectionBox>
        ...
        >
          {data.impact ? (
            <div>
              <div style={{ display: "flex", gap: 16, marginBottom: 16, flexWrap: "wrap" }}>
                <div style={{ padding: "10px 16px", background: "var(--color-ivory)", borderRadius: 8, flex: 1 }}>
                  <small style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--color-muted)" }}>ORIGIN PLANT</small>
                  <p style={{ margin: "2px 0 0", fontSize: 16, fontWeight: 600 }}>{data.impact.originModule}</p>
                </div>
                <div style={{ padding: "10px 16px", background: "var(--color-ivory)", borderRadius: 8, flex: 1 }}>
                  <small style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--color-muted)" }}>DIRECT IMPACT</small>
                  <p style={{ margin: "2px 0 0", fontSize: 16, fontWeight: 600 }}>{data.impact.directImpact?.length ?? 0} modules</p>
                </div>
                <div style={{ padding: "10px 16px", background: "var(--color-ivory)", borderRadius: 8, flex: 1 }}>
                  <small style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--color-muted)" }}>INDIRECT IMPACT</small>
                  <p style={{ margin: "2px 0 0", fontSize: 16, fontWeight: 600 }}>{data.impact.indirectImpact?.length ?? 0} modules</p>
                </div>
              </div>

              <h4 style={{ fontSize: 13, fontFamily: "var(--font-mono)", color: "var(--color-muted)", marginBottom: 8 }}>
            ...
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>Computing impact radius…</p>
          )}
        </SectionBox>
        ...
        >
          {data.root ? (
            <div>
              ...
              >
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                  <small style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--color-muted)" }}>ESTIMATED ROOT CAUSE</small>
                  <span
                    style={{
                      fontFamily: "var(--font-mono)",
                      fontSize: 11,
              ...
              {data.root.evidence && (
                <div>
                  <h4 style={{ fontSize: 12, fontFamily: "var(--font-mono)", color: "var(--color-muted)", margin: "0 0 6px" }}>
                    SUPPORTING EVIDENCE SIGNALS
                  </h4>
                  <ul style={{ margin: 0, paddingLeft: 18, fontSize: 13, lineHeight: 1.6, color: "var(--color-muted-strong)" }}>
            ...
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>Investigating root cause signals…</p>
          )}
        </SectionBox>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
            <label style={{ fontSize: 14, color: "var(--color-muted-strong)" }}>
          ...
          {data.simulation && (
            <div style={{ padding: 16, background: "var(--color-ivory)", borderRadius: 10, border: "1px solid var(--color-sage-soft)" }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        border: isCurrent ? "none" : "1px solid var(--color-sage-soft)",
                        fontFamily: "var(--font-mono)",
                        fontSize: 12,
                        textAlign: "center",
                        flex: 1,
                ...
                {issue.history?.length > 0 ? (
                  issue.history.map((h: any) => (
                    ...
                    >
                      ...
                      <span style={{ color: "var(--color-muted)" }}>{new Date(h.createdAt).toLocaleDateString()}</span>
                    </div>
                  ))
                ) : (
                  <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>No status changes recorded yet.</p>
                )}
              </div>
            </div>
          ) : (
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>Loading lifecycle telemetry…</p>
          )}
        </SectionBox>
        ...
        >
          {data.memory?.length > 0 ? (
            <div style={{ display: "grid", gap: 10 }}>
              {data.memory.map((mem: any) => (
                ...
                >
                  ...
                  <p style={{ margin: "4px 0", fontSize: 13, color: "var(--color-muted-strong)" }}>
            ...
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>No memory matches recorded for this pattern.</p>
          )}
        </SectionBox>
        ...
        >
          {data.recommendation?.length > 0 ? (
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 12 }}>
              {data.recommendation.map((rec: any) => (
                ...
                >
                  ...
                  <p style={{ margin: "0 0 8px", fontSize: 12, color: "var(--color-muted)" }}>{rec.developer.email}</p>
                  <ul style={{ margin: 0, paddingLeft: 16, fontSize: 12, lineHeight: 1.5, color: "var(--color-muted-strong)" }}>
            ...
            <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>No expert recommendation available for this issue. Add contributors with relevant module experience or resolution history to enable matching.</p>
          )}
        </SectionBox>
        ...
        >
          {!isResolved ? (
            <div style={{ padding: 14, background: "var(--color-ivory)", borderRadius: 8, fontSize: 13, color: "var(--color-muted-strong)" }}>
            ...
            {data.prevention?.map((item: any) => {
              ...
              return (
                <div
                  ...
                  style={{
                    padding: "12px 16px",
                    background: completed ? "var(--color-teal-bg)" : "var(--color-ivory)",
                    borderRadius: 8,
                    border: completed ? "1px solid var(--color-sage-soft)" : "1px solid var(--color-sage-soft)",
                    display: "flex",
                    justifyContent: "space-between",
                    alignItems: "center",
                  }}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <span
                      style={{
                        ...
                        padding: "2px 8px",
                        borderRadius: 6,
                        background: completed ? "var(--color-teal-bg)" : "var(--color-ivory-deep)",
            ...
            {issue.comments?.length > 0 ? (
              issue.comments.map((c: any) => (
                ...
                >
                  ...
                  <p style={{ margin: 0, fontSize: 13, color: "var(--color-muted-strong)" }}>{c.body}</p>
                </div>
              ))
            ) : (
              <p style={{ fontSize: 13, color: "var(--color-muted)", margin: 0 }}>No comments recorded yet.</p>
            )}
          </div>
